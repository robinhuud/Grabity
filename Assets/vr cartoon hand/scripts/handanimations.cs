...
public class handanimations : MonoBehaviour
{
    ...
    void CheckTriggers()
    {
        anim.SetFloat("IndexTrigger", OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, currentController));
        anim.SetFloat("HandTrigger", OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger, currentController));
    }
